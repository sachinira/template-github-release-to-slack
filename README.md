# Template: GitHub new release to Slack message
## Integration Use Case
When new release is done, send a message to a Slack channel. <br>
This template is useful when we want to send a message to a targeted Slack channel when there is a new release in a 
...
`$  bal run target/bin/github_to_slack-0.1.0.jar`. 
...
4. You can check the Slack channel to verify that new message is added. 
